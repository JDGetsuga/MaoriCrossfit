...
class FunctionsControllerTest < ActionController::TestCase
  ...
  test "should create function" do
    assert_difference('Function.count') do
      post :create, function: { descripcion: @function.descripcion, tipo: @function.tipo, titulo: @function.titulo }
    end
  ...
  test "should update function" do
    patch :update, id: @function, function: { descripcion: @function.descripcion, tipo: @function.tipo, titulo: @function.titulo }
    assert_redirected_to function_path(assigns(:function))
  end
